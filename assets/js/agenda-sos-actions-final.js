...
(function(){
  ...
  function ensureAppointment(op,state){
    ...
    let appointment=linked.find(a=>a.professional===acceptedProfessional)||linked[0]||null;
    ...
    if(appointment){
      ...
      op.appointmentId=appointment.id;op.acceptedBy=acceptedProfessional;op.status='resolved';op.endTime=end;
    ...
    op.appointmentId=id;op.acceptedBy=acceptedProfessional;op.status='resolved';op.endTime=appointment.endTime;
    write(state);
    return appointment;
  }
